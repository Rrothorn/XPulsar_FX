...
background_img = 'linear-gradient(to left, rgba(0,0,0,1), rgba(12,77,21,1))'
card_title_img = 'linear-gradient(to left, rgba(12,77,21  ,0.75), rgba(0,0,0,1))'
...
def update_page1(selected_stop, selected_leverage, selected_slip, selected_period):
    ...
    cost = 0.1/10000
    slip = selected_slip/(150000)  # divided by value of 1 nasdaq future 
    ...
    dfc['pnl_ac'] = 0
    dfc['pnl_ac'][dfc[pnlcol] != 0] = leverage * (dfc[pnlcol] - cost - slip)
